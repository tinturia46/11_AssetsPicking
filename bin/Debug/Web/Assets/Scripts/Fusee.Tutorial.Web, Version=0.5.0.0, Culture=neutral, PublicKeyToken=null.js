...
(function Tutorial$Members () {
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0A.Fusee.Tutorial.Core.AssetsPicking)) ();
  };
  var $T0B = function () {
  ...
  function Tutorial_Main () {
    ...
    var assetsPicking = new ($T0A())();
    assetsPicking.RenderCanvas$CanvasImplementor$value = new ($T0C())();
    assetsPicking.RenderCanvas$ContextImplementor$value = new ($T0D())(assetsPicking.RenderCanvas$CanvasImplementor$value);
    $T0E().AddDriverImp(new ($T0F())(assetsPicking.RenderCanvas$CanvasImplementor$value));
    assetsPicking.Run();
  }; 
